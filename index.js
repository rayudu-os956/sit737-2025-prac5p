...
app.post('/exponentiate', (req, res) => handleOperation(req, res, 'exponentiate'));
...
app.get('/operations', (req, res) => {
    res.json({
        operations: ['add', 'subtract', 'multiply', 'divide', 'exponentiate', 'sqrt', 'modulo']
    });
});
    ...
    switch (operation) {
        ...
        case 'sqrt':
            if (num1 < 0) {
                ...
                return res.status(400).json({ error: 'Invalid input. Square root cannot be taken for negative numbers.' });
            }
